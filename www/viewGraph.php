...
$imgString = "cgi-bin/viewGraph.cgi?action=zoom&graph_start=$graph_start&graph_end=$graph_end&graph_height=150&graph_width=700&rrdFile=$rrdFile&data=$data";
...
?>
    ...
    <img id='zoomGraphImage' src='<?php echo $imgString ?>' border='0' alt=''>
...
// Global constant
var cURLBase = "viewGraph.php?action=zoom";
    ...
    if ((gMouseObj.leftButtonPressed()) && (gMouseObj.dragging)) {
        ...
        if (((gMouseObj.startedX < gZoomGraphObj.zoomBoxLeft) && (gMouseObj.stoppedX < gZoomGraphObj.zoomBoxLeft)) ||
            ...
            if ((minX != maxX) || (minY != maxY)) {
                ...
                newGraphYMin = Math.round(0 + minY * OnePixel);
                newGraphYMax = Math.round(0 + maxY * OnePixel);
